...
SUBJECT="sub-106v2s1" # to do: sub-102v2s1, sub-102v2s2, sub-105v1s2, sub-107v1s1, sub-107v1s2, sub-107v2s1, sub-107v2s2

# places
DATA_DIR="/Users/yyi/Desktop/ENGRAMS/preproc/${SUBJECT}/dwi"
