...
config_file="/Users/yyi/Desktop/ENGRAMS/scripts/final_workflow/Zs_ENGRAMS_dcm2bids_vf-4.json" # dcm2bids config file
subject_ids=("305v2s1" "305v2s2" "307v1s1" "307v1s2" "310v1s1" "310v1s2") #("101v1s1" "101v1s2" "101v2s1" "101v2s2" "102v1s1" "102v1s2" "102v2s1" "102v2s2" "103v1s1" "103v1s2" "103v2s1" "103v2s2")                  # List of subject IDs
...
for subject in "${subject_ids[@]}"; do
    ...
    # rm -rf "${temp_dir}"
    gzip ${output_dir}/sub-${subject}/func/*.nii
