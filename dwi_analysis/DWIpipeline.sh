...
for I in sub104_v1s1 sub104_v1s2 sub104_v2s2 sub105_v1s2 sub105_v2s2 sub106_v1s1 sub106_v1s2 sub106_v2s1 sub106_v2s2 sub107_v1s1 sub107_v1s2 sub107_v2s2 
do
