...
# workspaces
NORDIC_DIR="/Volumes/korokdorf/ENGRAMS/analyses/${SUBJECT}/dwi/nordic"
DWI_DIR="/Volumes/korokdorf/ENGRAMS/preproc/${SUBJECT}/dwi"
OUTPUT_DIR="/Volumes/korokdorf/ENGRAMS/analyses/${SUBJECT}/dwi"
...
#                 -m "${OUTPUT_DIR}/${SUBJECT}_hifi_b0_brain_mask.nii.gz"
# on laptop
mri_synthstrip -i "${OUTPUT_DIR}/${SUBJECT}_hifi_b0.nii.gz" \
               -o "${OUTPUT_DIR}/${SUBJECT}_hifi_b0_brain.nii.gz" \
               -m "${OUTPUT_DIR}/${SUBJECT}_hifi_b0_brain_mask.nii.gz"
