...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and 
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 3.06;        % Short echo time in ms for Allegra
pm_def.LONG_ECHO_TIME = 4.08;         % Long echo time in ms for Allegra
...
pm_def.FWHM = 5;                      % FWHM of Gaussian filter used to 
...
pm_def.K_SPACE_TRAVERSAL_BLIP_DIR = -1; % +ve k-space = 1, -ve = -1. (ENGRAMS PE direction is 'j-')
pm_def.TOTAL_EPI_READOUT_TIME = 55.2529;   % Allegra EPI RO time (330E-6*64)
