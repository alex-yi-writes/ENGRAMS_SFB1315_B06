function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_ENGRAMS_ENC(varargin)
...
event1duration = 2;    % duration of scene
event2duration = 2;    % duration of object
event3duration = 2;    % duration of both presentation
