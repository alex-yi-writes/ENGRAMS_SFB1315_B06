function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_ENGRAMS_RCG_behavpilot(varargin)
...
ISIstep = .35;          % For 'geometric' only.  There is an optimal empirical value -- longer is better for deconvolution/FIR, but we also need to fit within total scan time constraints.
