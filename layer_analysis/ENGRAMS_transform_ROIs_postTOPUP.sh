...
do
	...
	if [[ "$ID" == sub-2* ]]; then
	    ...
	    func_origenc=${path_func}/mean${ID}v2s2_task-origenc_run-03_bold_topup
	    func_origrec=${path_func}/mean${ID}v2s2_task-origrec_run-04_bold_topup
	fi
	mkdir ${path_roi}
	mkdir ${path_trx}
