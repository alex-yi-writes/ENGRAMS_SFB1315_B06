...
for ID in sub-207 #sub-302 sub-303 #sub-205 sub-304
do
	...
	func_origrec=${path_func}/mean${ID}v1s1_task-origrec_run-04_bold_topup
	mkdir ${path_roi}
	mkdir ${path_trx}
	...
	# extract
	/Users/yyi/Desktop/ENGRAMS/script/ENGRAMS_binarise_ASHSseg_vf.sh ${path_roi}/hpc_on_func-rest.nii.gz ${path_roi}/func/rest
	/Users/yyi/Desktop/ENGRAMS/script/ENGRAMS_binarise_ASHSseg_vf.sh ${path_roi}/hpc_on_func-origenc.nii.gz ${path_roi}/func/origenc
	/Users/yyi/Desktop/ENGRAMS/script/ENGRAMS_binarise_ASHSseg_vf.sh ${path_roi}/hpc_on_func-origrec.nii.gz ${path_roi}/func/origrec
