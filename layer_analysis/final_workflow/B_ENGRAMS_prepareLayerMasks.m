...
eval(['!mri_synthstrip -i ' paths_results ids{id} '/anat/t1/m' ids{id} '_run-01_T1w_0pt35.nii.gz ' ...
    '-o ' paths_results ids{id} '/anat/t1/m' ids{id} '_run-01_T1w_0pt35_stripped.nii.gz ' ...
    '-m ' paths_results ids{id} '/anat/t1/brainmask.nii.gz'])
