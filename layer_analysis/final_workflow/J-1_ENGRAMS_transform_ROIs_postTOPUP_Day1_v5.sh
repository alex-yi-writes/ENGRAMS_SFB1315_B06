...
do
	...
	if [[ $MacBookFlag -eq 1 ]]; then
		t2w=/Users/yyi/Desktop/ENGRAMS/preproc/${ID}v1s1/anat/${ID}v1s1_T2w
	else
	...
	# extract
	/Users/yyi/Desktop/ENGRAMS/scripts/final_workflow/laminar/Z-1_ENGRAMS_binarise_ASHSseg_vf.sh ${path_roi}/hpc_on_func-rest.nii.gz ${path_roi}/func/rest
	/Users/yyi/Desktop/ENGRAMS/scripts/final_workflow/laminar/Z-1_ENGRAMS_binarise_ASHSseg_vf.sh ${path_roi}/hpc_on_func-origenc.nii.gz ${path_roi}/func/origenc
	/Users/yyi/Desktop/ENGRAMS/scripts/final_workflow/laminar/Z-1_ENGRAMS_binarise_ASHSseg_vf.sh ${path_roi}/hpc_on_func-origrec1.nii.gz ${path_roi}/func/origrec
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_anat}/t1/mri/p1m${ID}v1s1_run-01_T1w_0pt35_bin.nii.gz \
		-o ${path_roi}/func/origrec1/GM.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat

	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_anat}/t1/mri/p2m${ID}v1s1_run-01_T1w_0pt35_bin.nii.gz \
		-o ${path_roi}/func/origrec1/WM.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_R_layer_sup.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_R_layer_sup.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_L_layer_sup.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_L_layer_sup.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_layer_sup.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_layer_sup.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_R_layer_mid.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_R_layer_mid.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_L_layer_mid.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_L_layer_mid.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_layer_mid.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_layer_mid.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_R_layer_deep.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_R_layer_deep.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_L_layer_deep.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_L_layer_deep.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/RSC_layer_deep.nii.gz \
		-o ${path_roi}/func/origrec1/RSC_layer_deep.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_R_layer_sup.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_R_layer_sup.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_L_layer_sup.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_L_layer_sup.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_layer_sup.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_layer_sup.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_R_layer_mid.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_R_layer_mid.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_L_layer_mid.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_L_layer_mid.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_layer_mid.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_layer_mid.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	...
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_R_layer_deep.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_R_layer_deep.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_L_layer_deep.nii.gz \
		-o ${path_roi}/func/origrec1/mPFC_L_layer_deep.nii.gz \
		-t ${path_trx}/wb2origrec_0GenericAffine.mat
	antsApplyTransforms -d 3 -v 0 -n NearestNeighbor \
		-r ${func_origrec}_stripped.nii.gz \
		-i ${path_roi}/native/mPFC_layer_deep.nii.gz \
