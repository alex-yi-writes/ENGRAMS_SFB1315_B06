...
---
## 🔥🔥🔥 an update (16-04-2026): i have now uploaded a (hopefully) [`final workflow`](./final_workflow/) to this repository. if you order the scripts by filename, you can just run them from top to bottom sequentially.
---
