...
expName = 'N_forgetting_curve'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\PhilippFeistmantl\\OneDrive - uibk.ac.at\\EMMA\\Pavlovia\\Forgetting curve neutral\\N_forgetting_curve_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('Excel_forgetting_curve_neutral.xlsx'),
