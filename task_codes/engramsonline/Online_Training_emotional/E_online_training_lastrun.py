...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/Alex/engramsonline/Online_Training_emotional/E_online_training_lastrun.py',
...
introductionComponents = [introduction_text, text_introduction_button, mouse_2]
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('Excel_online_training_emotional.xlsx'),
...
for thisTrial in trials:
    ...
    gotValidClick = False  # until a click is received
    # keep track of which components have finished
    recognitionComponents = [question_emotional, image_top_3, image_left, image_middle, image_right, mouse]
    ...
    # keep track of which components have finished
    solutionComponents = [image_top_solution, image_solution]
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
endComponents = [textbox_2, textbox_3, polygon, mouse_3]
